...
export default function NewProject({onSave}){
    ...
    function handleSave(){
        ...
        onSave({title: enteredTitle, description: enteredDescription, dueDate: enteredDueDate});
    }
    ...
    <>
        <Modal ref={modal} buttonLabel='Close'>
            ...
            <p className='text-stone-600 mb-4'>Please make sure you provide a valid value every input field</p>
        </Modal>
